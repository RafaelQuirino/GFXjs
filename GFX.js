...
function GFX(canvasId) {
	...
	//Attributes
  	...
  	obj.context = null;
    obj.font = '10px Arial';
    obj.backgroundColor = new __gfx_aux.Color(255,255,255);
    obj.foregroundColor = new __gfx_aux.Color(0,0,0);
    obj.color = new __gfx_aux.Color(0,0,0);
    ...
    obj.init = function(canvasId) {
	    if (arguments.length == 0) {
	    	...
	    	throw 'Wrong arguments. Could not create Graphics object.'
	  	}
